...
const SOCO_LIVE_STREAM = 'https://pull.niues.live/live/stream-534219_lhd.m3u8?auth_key=1782870503-0-0-583a444374b6f6ba206bf1f164e2b93a';
    ...
    <section className="animate-fade-in" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* socoLive Channel Card */}
          <div
            onClick={() => onPlayStream(SOCO_LIVE_STREAM)}
            className="glass-glow"
            style={{
              flex: '1 1 280px',
              maxWidth: '340px',
              ...
              position: 'relative',
              boxShadow: 'var(--card-shadow), 0 4px 20px rgba(168, 85, 247, 0.05)'
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = 'translateY(-6px)';
            ...
            onMouseLeave={(e) => {
              ...
              e.currentTarget.style.boxShadow = 'var(--card-shadow), 0 4px 20px rgba(168, 85, 247, 0.05)';
            }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', textAlign: 'left' }}>
              <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '10px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <span className="live-indicator-dot" />
                <span style={{ fontSize: '0.75rem', fontWeight: 700, color: '#a855f7', textTransform: 'uppercase', letterSpacing: '0.05em' }}>LIVE</span>
              </div>
              <div style={{
                background: 'var(--text-primary)',
                color: 'var(--bg-color)',
